...
var NRS = (function(NRS, $) {
    ...
    var coinToPair = function (op, coin) {
        return (op == "buy") ? "GALA_" + coin : coin + "_GALA";
    };

    var pairToCoin = function (pair) {
        if (pair.indexOf("GALA_") == 0) {
            return pair.substring("GALA_".length);
        }
        if (pair.indexOf("_GALA") == pair.length - "_GALA".length) {
            return pair.substring(0, pair.indexOf("_GALA"));
        }
    ...
    NRS.getFundAccountLink = function() {
        return "<div class='callout callout-danger'>" +
            ...
            "</div>" +
			 "<a href='https://spf.teststrana.com/mycred/' class='btn btn-xs btn-default'  target='_blank' rel='noreferrer noopener'>Buy via PayPal</a>" +
            "<a href='#' class='btn btn-xs btn-default' data-toggle='modal' data-target='#m_send_amount_sell_modal' " +
            "data-pair='BTC_GALA'>" + $.t("fund_account_message", { "symbol": NRS.constants.COIN_SYMBOL }) + "</a>";
    };
