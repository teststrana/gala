...
const options = {
    url: "http://localhost:6876", // URL of GALA remote node
...
exports.load = function(callback) {
    ...
    require("jsdom").env("", function(err, window) {
        try {
            ...
            // the GALA client wasn't designed with modularity in mind therefore we need
            ...
            // Now load some GALA specific libraries into the global scope
            ...
            // however the GALA client relies on a global browser scope which defines the NRS object
